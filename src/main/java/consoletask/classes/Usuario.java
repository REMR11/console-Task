...
public class Usuario {
     ...
     * de �xito, as� como el nodo encontrado
     */
    public Map<String, Object> buscar(int referencia) {

        // Inicializaci�n del mapa de retorno
     ...
     * @param usuarioInverso Usuario al que se le asignar� la tarea
     */
    ...
    public void modificarPorcentajeTarea(Nodo tarea, int porcentaje) {
        ...
        // Valida si se ingres� porcentaje 100, para tambi�n establecer la tarea como finalizada
        if (porcentaje == 100) {
    ...
    public void modificarEstadoTarea(Nodo tarea, int estado) {
        ...
        // Valida si el estado que se ingres� es FINALIZADA, para tambi�n establecer el porcentaje al 100
    ...
    /**
     * M�todo para filtrar tareas por fecha de fin
     *
     ...
     * @return Una copia de la lista de tareas, vac�a o con los resultados
     * obtenidos
     */
    public Nodo filtrarPorFecha(LocalDate fecha1, LocalDate fecha2, Nodo cabezaTareas) {
        ...
        while (cabezaTareas != null) {
            ...
            // Comparaci�n de fechaFin de tarea con fechas ingresadas para filtro
            if (validaciones.filtrarPorFechas(fechaFin, fecha1, fecha2)) {

                Tarea tareaEncontrada = cabezaTareas.getTarea();
                // Duplicaci�n de lista
                // Si copia est� vac�a, guarda tarea encontrado al final
                if (copiaCabeza.getTarea() == null) {
                    copiaCabeza.setTarea(tareaEncontrada);
                } else {
                    // Sino, va recorriendo hasta encontrar el �ltimo nodo y guardar la tarea encontrada
    ...
    /**
     * M�todo que imprime la lista filtrada de tareas
     *
